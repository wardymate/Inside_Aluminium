...
gem 'spree_stock_transfers', '3.0.4', :path => '../inside_aluminium_store/extensions/spree_stock_transfers'
gem 'spree_stock_movements', '3.0.4', :path => '../inside_aluminium_store/extensions/spree_stock_movements'
