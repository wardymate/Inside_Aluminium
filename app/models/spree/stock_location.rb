module Spree
  class StockLocation < Spree::Base
    ...
    def restock_1(variant, quantity, originator = nil, sales_order_id)
      move_1(variant, quantity, originator, sales_order_id)
    end
    ...
    def move_1(variant, quantity, originator = nil, sales_order_id)
      stock_item_or_create(variant).stock_movements.create!(quantity: quantity,
                                                            originator: originator,
